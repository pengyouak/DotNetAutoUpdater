...
namespace DotNetAutoUpdater
{
    ...
    public interface IPersistenceProvider
    {
        ...
        /// <summary>
        /// Reads the value containing the date and time at which the user must be given again the
        /// possibility to upgrade the application.
        /// </summary>
        /// <returns>
        /// Returns a DateTime value at which the user must be given again the possibility to
        /// upgrade the application. If remind later value is not present then it will return null.
        /// </returns>
        ...
        /// </summary>
        /// <param name="version">
        /// Version code for the specific version that must be ignored. Set it to null if you don't
        /// want to skip any version.
        /// </param>
        void SetSkippedVersion(Version version);

        /// <summary>
        /// Sets the date and time at which the user must be given again the possibility to upgrade
        /// the application.
        /// </summary>
